...
const projectCategories = [
  {
    ...
    image: "project-parksafe-ai.webp",
    projects: [
      {
        name: "ParkSafe AI",
      ...
      },
      {
        ...
        image: "project-dental-ai-real.webp",
      ...
      },
      {
        ...
        image: "project-salon-chatbot-real.webp",
      ...
      },
      {
        ...
        image: "project-course-assistant-real.webp",
...

  {
    ...
    image: "project-credit-fraud-dashboard.webp",
    projects: [
      {
      ...
      },
      {
        ...
        image: "project-diabetes-prediction.webp",
      ...
      },
      {
        ...
        image: "project-cervical-cancer.webp",
      ...
      },
      {
        ...
        image: "project-utility-bill-real.webp",
...

  {
    ...
    image: "project-hr-attrition.webp",
    projects: [
      {
      ...
      },
      {
        ...
        image: "project-credit-card-ui.webp",
...

  {
    ...
    image: "project-salon-chatbot.webp",
    projects: [
      {
      ...
      },
      {
        ...
        image: "project-utility-anomaly.webp",
...

  {
    ...
    image: "project-course-assistant.webp",
    projects: [
      {
...
function renderCategoryTabs(activeId) {
  categoryTabs.innerHTML = projectCategories
    .map(
      (category) => `
        <button
          class="category-tab ${category.id === activeId ? "active" : ""}"
          type="button"
...
function renderProjects(categoryId = "ai") {
  const category =
    projectCategories.find((item) => item.id === categoryId) ||
    projectCategories[0];
  ...
  projectGrid.innerHTML = category.projects
    .map(
      (project, index) => `
        <article
          class="project-card dynamic-card ${
            index === 0 && category.projects.length > 2 ? "featured" : ""
          }"
          style="--card-index: ${index}"
        >
          <div class="project-visual">
            <img
              src="${project.image || category.image}"
...
contactForm.addEventListener("submit", (event) => {
  ...
  window.location.href =
    `mailto:shrutivanparia171@gmail.com?subject=${subject}&body=${body}`;
});
